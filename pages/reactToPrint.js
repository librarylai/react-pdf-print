...
const ReactToPrintContainer = styled.div`
  width: 100%;
`
...
export default function ReactToPDF({ fromServer }) {
...
// getServerSideProps 代表每次進到 這頁面時都會呼叫，不管你是 Client side 切換 or Server side render
export async function getServerSideProps() {
  console.log('123123123')
  return {
    props: {
      fromServer: '123213123',
    },
  }
}
